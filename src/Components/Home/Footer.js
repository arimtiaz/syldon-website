        ...
        <div class="w-screen max-w-6xl mx-auto text-left flex-col px-6 py-20 lg:flex lg:px-10 xl:px-24">
          ...
          <div class="lg:flex lg:flex-row lg:justify-between">
            ...
            <div>
              ...
              <div class="mb-8 mt-6 flex flex-row">
                <a
                  href=""
                  class="mr-4 text-black transition hover:text-gray-400"
                >
                  <svg
                    class="fill-current"
                    width="24"
                ...
                <a
                  href=""
                  class="mx-4 text-black transition hover:text-gray-400"
                >
                  <svg
                    class="fill-current"
                    width="24"
            ...
            <div class="mt-10 flex flex-col lg:mt-0">
              ...
              <div class="mb-4 flex flex-row items-center">
                ...
                <p class="font-inter ml-4 text-black">
              ...
              <div class="mb-4 flex flex-row items-center">
                ...
                <p class="font-inter ml-4 text-black">support@syldon.xyz</p>
              </div>
            </div>
          </div>
          {/* <!-- DIVIDER --> */}
          ...
          <div>
            <p class="font-inter text-center text-sm text-gray-500 lg:mt-0">
              © Copyright AR Imtiaz. All rights reserved.
            </p>
          </div>
        </div>
      </section>
