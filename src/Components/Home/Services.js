...
<section>
  ...
  <div class="mx-auto w-full max-w-6xl px-5 py-12 md:px-10 md:py-16 lg:py-20 text-left">
    ...
    <div class="grid items-center gap-8 lg:grid-cols-2 lg:gap-20">
      {/* <!-- Item --> */}
      <div class="py-20">
        <h2 class="mb-6 text-3xl font-bold md:mb-10 md:text-5xl lg:mb-12">Understand sales performance better</h2>
        <ul class="grid max-w-2xl grid-cols-2 sm:gap-5 lg:max-w-none">
          <li class="flex flex-col p-5">
            <img src="https://assets.website-files.com/6458c625291a94a195e6cf3a/6458c625291a945e53e6cf8f_Ellipse%2011%20(1).svg" alt="" class="mb-4 inline-block h-10 w-10" />
      ...
      <div class="h-full w-full">
        <img src="https://assets.website-files.com/6458c625291a94a195e6cf3a/6458c625291a940836e6cf8d_Group%2047854%20(2).svg" alt="" class="mx-auto inline-block h-full w-full max-w-[640px] object-cover" />
      </div>
    </div>
  </div>
</section>
